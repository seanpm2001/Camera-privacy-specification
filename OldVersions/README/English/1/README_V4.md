...
</details> <!-- End of wireless connectivity section !-->
...
</details> <!-- End of Additional cameras, Internet connnections, and virtual assistants section !-->
...
</details> <!-- End of Following the specification section !-->
...
</details> <!-- End of Additional cameras section !-->
...
</details> <!-- End of Specification application section !-->
...
</details> <!-- End of specification section !-->
...
<details><summary><p lang="en"><b>Version 4 (2024, Tuesday, October 15th at 12:25 pm PST)</b></p></summary>
...
- [x] Converted lid image syntax from Markdown to HTML
- [x] Split off and simplified the `Wireless connectivity` section
- [x] Updated the licensing section, increasing the license count to 10, and adding SPDX identifiers to each license
- [x] Added information about lid covering webcam light
- [x] Added System76 as a potential user
- [x] Updated the file history section
- - [x] Added an entry for version 4
- - [x] Added attribution for entries 1 to 4
